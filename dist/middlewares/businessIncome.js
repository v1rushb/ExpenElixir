...
router.post('/add-user-income/:id', authMe, premiumAuth, checkBusiness, validateIncome, async (req, res, next) => {
...
router.delete('/delete-user-income/:id', authMe, premiumAuth, checkBusiness, async (req, res, next) => {
...
router.put('/:id', authMe, premiumAuth, checkBusiness, validateIncome, async (req, res, next) => {
